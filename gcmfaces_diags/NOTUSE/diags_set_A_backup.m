% set whether to use pre-defined y axes for plots
useYlims = 0;
...
elseif userStep==3;%computational part;
        ...
        for bb=listBasins;
            ...
            elseif bb==2;   mskC=llc45_basin({'atlExt'}); mskC=mk3D(mskC,fldU);
            elseif bb==3;   mskC=llc45_basin({'pacExt','indExt'}); mskC=mk3D(mskC,fldU);
            end;
            ...
            % DEA commented out cutoffs by latitude
            if bb==1;
